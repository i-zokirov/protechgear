...
const datastoreKey = JSON.parse(fs.readFileSync("backend/keys/datastore-key.json", "utf-8"))
// Create a client
const datastore = new Datastore({projectId: datastoreKey.project_id, credentials: datastoreKey});
